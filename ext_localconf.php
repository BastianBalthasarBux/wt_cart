...
if ( ( $version16 >= 0 ) && ( $version20 < 0 ) ) {
	$GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['powermail']['PM_MainContentHookAfter'][]	= 'EXT:wt_cart/Classes/Hooks/Forms16.php:tx_wtcart_powermail';
	$GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['powermail']['PM_SubmitEmailHook'][]			= 'EXT:wt_cart/Classes/Hooks/Forms16.php:tx_wtcart_powermail';
	$GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['powermail']['PM_MandatoryHook'][]			= 'EXT:wt_cart/Classes/Hooks/Forms16.php:tx_wtcart_powermail';
	$GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['powermail']['PM_SubmitLastOne'][]			= 'EXT:wt_cart/Classes/Hooks/Forms16.php:tx_wtcart_powermail';
}
